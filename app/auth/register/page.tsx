        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-secondary/30 px-4">
                <div className="w-full max-w-md text-center">
                    <div className="rounded-2xl border border-success/30 bg-success/5 p-10">
                        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-success">
                            <Mail className="h-10 w-10 text-success-foreground" />
                        </div>
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="rounded-2xl border border-border bg-card/80 backdrop-blur-sm p-8 shadow-xl">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {/* Removed Role Selection for unified accounts */}
